            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-4 shadow">
                    <div class="modal-header p-5 pb-4 border-bottom-0">
                        ...
                        <h3 class="fw-semibold mb-0 fs-3">Troque a sua Senha</h3>
                    </div>
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <form class="" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-3" name="usuario" id="floatingUsuario" value="<?php echo $usuario; ?>" placeholder="Ex. claudio">
                                <label for="floatingUsuario">Usuário</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-3" name="senha_atual" id="floatingSenhaAtual" value="<?php echo $senha_atual; ?>" placeholder="Ex. claudio">
                                <label for="floatingSenhaAtual">Senha Atual</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-3" name="nova_senha" id="floatingNovaSenha" value="<?php echo $nova_senha; ?>" placeholder="Ex Flavio258@">
                                <label for="floatingNovaSenha">Nova Senha</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-3" name="confirmar_senha" id="floatingConfirmaSenhad" value="<?php echo $confirma_senha; ?>" placeholder="Ex Flavio258@">
                                <label for="floatingConfirmaSenhad">Confirme a nova senha</label>
                            </div>
